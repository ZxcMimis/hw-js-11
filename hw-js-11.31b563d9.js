...
const countdownInterval = setInterval(()=>{
    ...
    if (countdownTimer === 1799) alert("\u0417\u0430\u043B\u0438\u0448\u0438\u043B\u043E\u0441\u044C \u043C\u0435\u043D\u0448\u0435 \u043F\u043E\u043B\u043E\u0432\u0438\u043D\u0438 \u0447\u0430\u0441\u0443 :)");
    if (countdownTimer <= 0) clearInterval(countdownInterval);
}, 10);
...
btnTimerStart.addEventListener('click', ()=>{
    ...
    const interval = setInterval(()=>{
        ...
        if (timer === 10) document.querySelector('.box').classList.add('box-animation');
        if (timer <= 0) {
...
},{}]},["ihYAY","a0t4e"], "a0t4e", "parcelRequire62ed")

//# sourceMappingURL=hw-js-11.31b563d9.js.map
